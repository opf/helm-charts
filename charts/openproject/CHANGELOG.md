...
- 828ce6e: Upgrade OpenProject core version to 17.7.2 (patch update)
...
- 28a9b73: Upgrade OpenProject core version to 17.4.0 (minor update)

## 13.5.5

### Patch Changes

- b857364: Respect environment.SECRET_KEY_BASE to not output a secret file.
...
- 1eb9586: Upgrade OpenProject core version to 17.3.1 (patch update)

## 13.5.0

### Minor Changes

- 1f4e9c7: Upgrade OpenProject core version to 17.3.0 (minor update)
